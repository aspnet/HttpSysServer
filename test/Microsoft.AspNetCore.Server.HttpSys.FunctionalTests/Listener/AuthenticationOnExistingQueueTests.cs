...
namespace Microsoft.AspNetCore.Server.HttpSys.Listener
{
    public class AuthenticationOnExistingQueueTests
    {
        ...
        {
            string address;
            using (var baseServer = Utilities.CreateHttpAuthServer(authType, AllowAnoymous, out address))
        ...
        {
            string address;
            using (var baseServer = Utilities.CreateHttpAuthServer(authType, DenyAnoymous, out address))
        ...
        {
            string address;
            using (var baseServer = Utilities.CreateHttpAuthServer(AuthenticationSchemes.Kerberos, DenyAnoymous, out address))
            using (var server = Utilities.CreateServerOnExistingQueue(AuthenticationSchemes.Kerberos, DenyAnoymous, baseServer.Options.RequestQueueName))
            {
                Task<HttpResponseMessage> responseTask = SendRequestAsync(address, useDefaultCredentials: true);
        ...
        {
            string address;
            using (var baseServer = Utilities.CreateHttpAuthServer(AuthenticationSchemes.Kerberos, AllowAnoymous, out address))
